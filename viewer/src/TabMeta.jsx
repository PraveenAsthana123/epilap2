...
export const TAB_META = {
  ...
  charts: { title: 'Charts',
    input: 'eeg_model_metrics/feature_importance/class_balance/loss_curve/threshold_sweep CSVs',
    process: 'render bar/pie/trend/radar/area with Recharts', output: 'interactive infographics',
    visualization: 'Recharts bar · pie · line · radar · area', report: 'docs/analysis/secondary-eeg-full.md' },
